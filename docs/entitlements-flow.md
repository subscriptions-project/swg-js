...
| ----- | ----- | ----------- |
| `exp` | [NumericDate](https://tools.ietf.org/html/rfc7519#page-6) (e.g. `1543596936` ) | When the token expires |
| `iat` | [NumericDate](https://tools.ietf.org/html/rfc7519#page-6) (e.g. `1543595136` ) | When the token was issued |
| `iss` | `subscribewithgoogle@system.gserviceaccount.com` | Issuer of the token |
| `aud` | URL (e.g. `https://example.com` ) | Audience of the token which will be the publisher's URL |

To validate the signature, use the keys found here:
