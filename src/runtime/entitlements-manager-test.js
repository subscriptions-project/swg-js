  ...
  describe('fetching', () => {
    ...
    it('should fetch empty response', async () => {
      fetcherMock
        .expects('fetch')
        .withExactArgs(
          'https://news.google.com/swg/_/api/v1/publication/pub1/article?contentType=CLOSED',
          {
            method: 'GET',
    ...
    it('should fetch metering entitlements', async () => {
      ...
      fetcherMock
        .expects('fetch')
        .withExactArgs(
          `https://news.google.com/swg/_/api/v1/publication/pub1/article?contentType=CLOSED&encodedEntitlementsParams=${encodedParams}`,
          {
            method: 'GET',
            headers: {'Accept': 'text/plain, application/json'},
            credentials: 'include',
    ...
    it('should warn users about deprecated param', async () => {
      fetcherMock
        .expects('fetch')
        .withExactArgs(
          'https://news.google.com/swg/_/api/v1/publication/pub1/article?crypt=deprecated&contentType=CLOSED',
          {
            method: 'GET',
            headers: {'Accept': 'text/plain, application/json'},
            credentials: 'include',
    ...
    it('should pass OPEN contentType for unlocked content to the article endpoint', async () => {
      ...
      fetcherMock
        .expects('fetch')
        .withExactArgs(
          `https://news.google.com/swg/_/api/v1/publication/pub1/article?contentType=OPEN&encodedEntitlementsParams=${encodedParams}`,
          {
            method: 'GET',
            headers: {'Accept': 'text/plain, application/json'},
            credentials: 'include',
    ...
    it('should use the article endpoint with preview config id param', async () => {
      ...
      fetcherMock
        .expects('fetch')
        .withExactArgs(
          `https://news.google.com/swg/_/api/v1/publication/pub1/article?previewConfigId=${configId}&contentType=CLOSED&encodedEntitlementsParams=${encodedParams}`,
          {
            method: 'GET',
            headers: {'Accept': 'text/plain, application/json'},
            credentials: 'include',
    ...
    it('should use the article endpoint with preview key param', async () => {
      ...
      fetcherMock
        .expects('fetch')
        .withExactArgs(
          `https://news.google.com/swg/_/api/v1/publication/pub1/article?previewConfigId=${configId}&previewKey=${previewKey}&contentType=CLOSED&encodedEntitlementsParams=${encodedParams}`,
          {
            method: 'GET',
            headers: {'Accept': 'text/plain, application/json'},
            credentials: 'include',
    ...
    it('should only include METERED_BY_GOOGLE client type if explicitly enabled', async () => {
      ...
      fetcherMock
        .expects('fetch')
        .withExactArgs(
          `https://news.google.com/swg/_/api/v1/publication/pub1/article?contentType=CLOSED&encodedEntitlementsParams=${defaultGoogleMeteringEncodedParams}`,
          {
            method: 'GET',
            headers: {'Accept': 'text/plain, application/json'},
            credentials: 'include',
    ...
    it('should send interaction_age with readTime', async () => {
      ...
      fetcherMock
        .expects('fetch')
        .withExactArgs(
          `https://news.google.com/swg/_/api/v1/publication/pub1/article?interaction_age=2&contentType=CLOSED`,
          {
            method: 'GET',
            headers: {'Accept': 'text/plain, application/json'},
            credentials: 'include',
