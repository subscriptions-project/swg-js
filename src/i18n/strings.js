...
export const I18N_STRINGS = {
  ...
  'SHOWCASE_REGWALL_CASL': {
    ...
    'cs': 'Přečtěte si <ph name="LINK_START"><ex>&lt;a&gt;</ex></ph>smluvní podmínky a&nbsp;souhlas podle legislativy CASL<ph name="LINK_END"><ex>&lt;/a&gt;</ex></ph> publikace <ph name="PUBLICATION"><ex>AP News</ex>{publication}</ph>',
    'de': 'Lies dir die <ph name="LINK_START"><ex>&lt;a&gt;</ex></ph>Bedingungen und die Einwilligung gemäß CASL<ph name="LINK_END"><ex>&lt;/a&gt;</ex></ph> der Publikation <ph name="PUBLICATION"><ex>AP News</ex>{publication}</ph> durch',
    ...
    'es': 'Revisa los <ph name="LINK_START"><ex>&lt;a&gt;</ex></ph>Términos y el consentimiento de la CASL<ph name="LINK_END"><ex>&lt;/a&gt;</ex></ph> de <ph name="PUBLICATION"><ex>AP News</ex>{publication}</ph>',
    'fr': 'Consultez les <ph name="LINK_START"><ex>&lt;a&gt;</ex></ph>Conditions d\'utilisation et l\'avis LCAP (Loi canadienne anti-pourriel)<ph name="LINK_END"><ex>&lt;/a&gt;</ex></ph> de <ph name="PUBLICATION"><ex>AP News</ex>{publication}</ph>',
    'fr-ca':
    ...
    'hi': '<ph name="PUBLICATION"><ex>AP News</ex>{publication}</ph> की <ph name="LINK_START"><ex>&lt;a&gt;</ex></ph>शर्तों और सीएएसएल (कैनेडियन एंटी-स्पैम लेजिस्लेशन) से जुड़ी सहमति<ph name="LINK_END"><ex>&lt;/a&gt;</ex></ph> के बारे में पढ़ें',
    'it': 'Rileggi i <ph name="LINK_START"><ex>&lt;a&gt;</ex></ph>Termini e il consenso ai sensi della legge CASL<ph name="LINK_END"><ex>&lt;/a&gt;</ex></ph> di <ph name="PUBLICATION"><ex>AP News</ex>{publication}</ph>',
    'ja': '<ph name="PUBLICATION"><ex>AP News</ex>{publication}</ph> の<ph name="LINK_START"><ex>&lt;a&gt;</ex></ph>利用規約と CASL への同意<ph name="LINK_END"><ex>&lt;/a&gt;</ex></ph>をご確認ください',
    'kn': '<ph name="PUBLICATION"><ex>AP News</ex>{publication}</ph> ಅವರ <ph name="LINK_START"><ex>&lt;a&gt;</ex></ph>ನಿಯಮಗಳು ಮತ್ತು CASL ಸಮ್ಮತಿ<ph name="LINK_END"><ex>&lt;/a&gt;</ex></ph> ಅನ್ನು ಪರಿಶೀಲಿಸಿ',
    'ml': '<ph name="PUBLICATION"><ex>AP News</ex>{publication}</ph> എന്നതിന്റെ <ph name="LINK_START"><ex>&lt;a&gt;</ex></ph>നിബന്ധനകളും CASL സമ്മതവും<ph name="LINK_END"><ex>&lt;/a&gt;</ex></ph> അവലോകനം ചെയ്യുക',
    'mr': '<ph name="PUBLICATION"><ex>AP News</ex>{publication}</ph>च्या <ph name="LINK_START"><ex>&lt;a&gt;</ex></ph>अटी आणि CASL संमती<ph name="LINK_END"><ex>&lt;/a&gt;</ex></ph> यांचे पुनरावलोकन करा',
    'nl': 'Bekijk de <ph name="LINK_START"><ex>&lt;a&gt;</ex></ph>Voorwaarden en CASL-toestemming<ph name="LINK_END"><ex>&lt;/a&gt;</ex></ph> van <ph name="PUBLICATION"><ex>AP News</ex>{publication}</ph>',
    'pt-br':
      'Confira os <ph name="LINK_START"><ex>&lt;a&gt;</ex></ph>Termos e o consentimento à CASL<ph name="LINK_END"><ex>&lt;/a&gt;</ex></ph> da publicação <ph name="PUBLICATION"><ex>AP News</ex>{publication}</ph>',
    'pt-pt':
      'Analise os <ph name="LINK_START"><ex>&lt;a&gt;</ex></ph>termos e o consentimento da CASL<ph name="LINK_END"><ex>&lt;/a&gt;</ex></ph> da publicação <ph name="PUBLICATION"><ex>AP News</ex>{publication}</ph>',
    'ta': '<ph name="PUBLICATION"><ex>AP News</ex>{publication}</ph> இன் <ph name="LINK_START"><ex>&lt;a&gt;</ex></ph>விதிமுறைகளையும் CASL ஒப்புதலையும்<ph name="LINK_END"><ex>&lt;/a&gt;</ex></ph> பாருங்கள்',
    'te': '<ph name="PUBLICATION"><ex>AP News</ex>{publication}</ph>‌కు చెందిన <ph name="LINK_START"><ex>&lt;a&gt;</ex></ph>నియమాలు CASL సమ్మతి<ph name="LINK_END"><ex>&lt;/a&gt;</ex></ph>ని రివ్యూ చేయండి',
  },
};
