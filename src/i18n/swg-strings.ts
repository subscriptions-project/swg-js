...
export const SWG_I18N_STRINGS = {
  ...
  'VIEW_AN_AD_FOR_FREE_ACCESS': {
    'en': 'View an ad for free access',
    'ar': 'View an ad for free access',
    'de': 'View an ad for free access',
    'en-au': 'View an ad for free access',
    'en-ca': 'View an ad for free access',
    'en-gb': 'View an ad for free access',
    'en-us': 'View an ad for free access',
    'es': 'View an ad for free access',
    'es-419': 'View an ad for free access',
    'fr': 'View an ad for free access',
    'fr-ca': 'View an ad for free access',
    'hi': 'View an ad for free access',
    'id': 'View an ad for free access',
    'it': 'View an ad for free access',
    'ja': 'View an ad for free access',
    'ko': 'View an ad for free access',
    'ms': 'View an ad for free access',
    'nl': 'View an ad for free access',
    'no': 'View an ad for free access',
    'pl': 'View an ad for free access',
    'pt': 'View an ad for free access',
    'pt-br': 'View an ad for free access',
    'ru': 'View an ad for free access',
    'se': 'View an ad for free access',
    'th': 'View an ad for free access',
    'tr': 'View an ad for free access',
    'uk': 'View an ad for free access',
    'zh-cn': 'View an ad for free access',
    'zh-hk': 'View an ad for free access',
    'zh-tw': 'View an ad for free access',
  },
};
