...
/**
 * This is the Google logo in base64 to be used in the src of an <img> tag.
 */
...
/**
 * Official Google G gradient logo URL (24px).
 */
export const GOOGLE_G_LOGO_URL =
  'https://www.gstatic.com/images/branding/productlogos/googleg_gradient/v1/24px.svg';
