 ...
 */
 ...
 describe('AnalyticsRequest', () => {
   it('should deserialize correctly', () => {
     ...
     timestamp.setSeconds(0);
     timestamp.setNanos(0);
     eventparams.setSubscriptionTimestamp(timestamp2);
 ...
 describe('EntitlementsRequest', () => {
   it('should deserialize correctly', () => {
     ...
     timestamp.setSeconds(0);
     timestamp.setNanos(0);
     entitlementsrequest.setSubscriptionTimestamp(timestamp2);
     ...
     expect(entitlementsrequestDeserialized.getSubscriptionTimestamp()).to.deep.equal(
         entitlementsrequest.getSubscriptionTimestamp());
 ...
 describe('EventParams', () => {
   it('should deserialize correctly', () => {
     ...
     timestamp.setSeconds(0);
     timestamp.setNanos(0);
     eventparams.setSubscriptionTimestamp(timestamp);
     ...
     expect(eventparamsDeserialized.getSubscriptionTimestamp()).to.deep.equal(
         eventparams.getSubscriptionTimestamp());
